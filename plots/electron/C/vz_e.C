...
//=========  (Wed Apr 30 13:46:10 2025) by ROOT version 6.34.08
   ...
   c1->Range(-37.89474,-32.66053,27.89474,239.5105);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   ...
   vz_e_stack_1->SetBinContent(88,197);
   vz_e_stack_1->SetEntries(197);
   ...
   vz_e_cut_stack_2->SetBinContent(88,197);
   vz_e_cut_stack_2->SetEntries(197);
   ...
   hs->Draw("nostack");
   TLine *line = new TLine(-15,0,-15,157.6);

   ci = TColor::GetColor("#ff2c00");
   line->SetLineColor(ci);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(5,0,5,157.6);
