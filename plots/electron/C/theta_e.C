...
//=========  (Wed Apr 30 13:46:10 2025) by ROOT version 6.34.08
   ...
   c1->Range(-5.526316,-32.66053,40.52632,239.5105);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   ...
   theta_e_stack_1->SetBinContent(32,197);
   theta_e_stack_1->SetEntries(197);
   ...
   theta_e_cut_stack_2->SetBinContent(32,197);
   theta_e_cut_stack_2->SetEntries(197);
